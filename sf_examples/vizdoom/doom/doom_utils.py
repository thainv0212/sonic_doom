...
DOOM_ENVS = [
    ...
    DoomSpec("doom_my_way_home_A1", "my_way_home-A1.cfg", doom_action_space_basic(), 1.0),
    DoomSpec("doom_my_way_home_A2", "my_way_home-A2.cfg", doom_action_space_basic(), 1.0),
    DoomSpec("doom_my_way_home_A3", "my_way_home-A3.cfg", doom_action_space_basic(), 1.0),
    DoomSpec("doom_my_way_home_b_A1", "my_way_home-b-A1.cfg", doom_action_space_basic(), 1.0),
    DoomSpec("doom_my_way_home_b_A2", "my_way_home-b-A2.cfg", doom_action_space_basic(), 1.0),
    DoomSpec("doom_my_way_home_b_A3", "my_way_home-b-A3.cfg", doom_action_space_basic(), 1.0),
    ...
    DoomSpec("doom_deadly_corridor_500", "deadly_corridor_500.cfg", doom_action_space_extended(), 0.01),
    DoomSpec("deadly_corridor-new-A1", "deadly_corridor-new-A1.cfg", doom_action_space_extended(), 0.01),
    DoomSpec("deadly_corridor-new-b-A1", "deadly_corridor-new-A1.cfg", doom_action_space_extended(), 0.01),
    DoomSpec("deadly_corridor-new-A2", "deadly_corridor-new-A1.cfg", doom_action_space_extended(), 0.01),
    DoomSpec("deadly_corridor-new-b-A2", "deadly_corridor-new-A1.cfg", doom_action_space_extended(), 0.01),
